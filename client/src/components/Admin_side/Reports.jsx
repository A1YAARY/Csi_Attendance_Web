...
const Reports = () => {
  ...
  <div className="max-w-6xl mx-auto">
    ...
    <div className="mb-8">
      ...
      <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-700 mb-2 pb-2">
      User Registration
      </h1>
    ...
    {/* Single User Registration */}
    {activeTab === "single" && (
      <div className="bg-white backdrop-blur-lg rounded-2xl p-8 shadow-xl border border-gray-100">
        ...
        <form onSubmit={handleSingleUserSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                placeholder="John Doe"
                required
              />
            </div>
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
              {Object.keys(singleUser.weeklySchedule).map((day) => (
                <label
                  key={day}
                  className={`flex items-center justify-center space-x-2 cursor-pointer p-3 rounded-xl border-2 transition-all ${
                    singleUser.weeklySchedule[day]
                ...
                >
                  <input
                    ...
                    className="w-5 h-5 text-indigo-600 bg-white border-gray-300 rounded focus:ring-2 focus:ring-indigo-500"
                  />
            ...
            <p className="text-sm text-gray-500 mt-4 bg-gray-50 p-3 rounded-lg">
              💡 <strong>Tip:</strong> Checked = Working day | Unchecked = Weekly off
            </p>
          </div>
          ...
          <div className="border-t border-gray-200 pt-6">
            <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
              <span className="bg-purple-100 text-purple-600 rounded-lg p-2 mr-3">🏖️</span>
              Custom Holidays (Optional)
            </h3>
            <div className="space-y-3">
              <input
                ...
                className="w-full md:w-1/2 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
              />
              <div className="flex flex-wrap gap-2">
                {singleUser.customHolidays.map((date, index) => (
                  <span
                    key={index}
                    className="inline-flex items-center px-4 py-2 bg-purple-100 border border-purple-200 rounded-full text-sm text-purple-700 font-medium"
                  >
                    {new Date(date).toLocaleDateString()}
                    <button
                      type="button"
          ...
          <button
            type="submit"
            disabled={loading || !organizationCode}
            className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-4 rounded-xl font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-indigo-200 transform hover:scale-[1.02] active:scale-[0.98]"
          >
            {loading ? (
      ...
      <div className="bg-white backdrop-blur-lg rounded-2xl p-8 shadow-xl border border-gray-100">
        ...
        <div className="mb-8 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-4 text-sm">
            ...
            <span className="text-green-600 font-medium">• institute *</span>
            <span className="text-green-600 font-medium">• department *</span>
            <span className="text-green-600 font-medium">• password *</span>
            <span className="text-gray-500">• phone</span>
            <span className="text-gray-500">• workingHoursStart</span>
            <span className="text-gray-500">• workingHoursEnd</span>
            <span className="text-gray-500">• weeklySchedule (7 days)</span>
            <span className="text-gray-500">• customHolidays</span>
          </div>
          <button
            onClick={downloadTemplate}
            className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-6 py-3 rounded-xl font-semibold transition-all shadow-lg shadow-blue-200 transform hover:scale-105"
          >
            📥 Download Excel Template
          </button>
        </div>
        ...
        <div className="mb-8">
          ...
          >
            ...
            <label
              htmlFor="file-input"
              className="inline-block bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-800 hover:to-gray-900 text-white px-6 py-3 rounded-xl cursor-pointer font-semibold transition-all shadow-lg transform hover:scale-105"
            >
              Browse Files
            </label>
            <input
          ...
          {selectedFile && (
            <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-xl flex items-center justify-between shadow-sm">
              <div>
                <p className="text-green-700 font-semibold flex items-center">
                  <span className="mr-2">✓</span> {selectedFile.name}
                </p>
              ...
              <button
                onClick={() => setSelectedFile(null)}
                className="text-red-500 hover:text-red-700 font-semibold px-3 py-1 rounded-lg hover:bg-red-50 transition-all"
              >
                Remove
              </button>
            </div>
        ...
        {uploadResults && (
          <div className="mt-8 space-y-4">
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-4 text-center shadow-sm">
                <div className="text-3xl font-bold text-yellow-600">
                  {uploadResults.summary?.duplicates || 0}
                </div>
                <div className="text-gray-600 font-medium">Duplicates</div>
              </div>
            </div>
            ...
            {uploadResults.results?.errors?.length > 0 && (
              <div className="bg-red-50 border border-red-200 rounded-xl p-4 shadow-sm">
                <h4 className="font-semibold text-red-700 mb-3 flex items-center">
                  <span className="mr-2">❌</span> Errors ({uploadResults.results.errors.length})
                </h4>
                <div className="space-y-2 max-h-60 overflow-y-auto">
                  {uploadResults.results.errors.map((error, index) => (
                    <div
                      key={index}
                      className="text-sm text-gray-700 bg-white p-3 rounded-lg border border-red-100"
                    >
                      <strong>Row {error.row}:</strong> {error.error}
                      {error.email && (
            ...
            {uploadResults.results?.duplicates?.length > 0 && (
              <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 shadow-sm">
                <h4 className="font-semibold text-yellow-700 mb-3 flex items-center">
                  <span className="mr-2">⚠️</span> Duplicates ({uploadResults.results.duplicates.length})
                </h4>
                <div className="space-y-2 max-h-60 overflow-y-auto">
                  {uploadResults.results.duplicates.map(
                    (duplicate, index) => (
                      <div
                        key={index}
                        className="text-sm text-gray-700 bg-white p-3 rounded-lg border border-yellow-100"
                      >
                        <strong>Row {duplicate.row}:</strong>{" "}
                        {duplicate.email} - User already exists
                      </div>
                ...
                <div className="space-y-2 max-h-60 overflow-y-auto">
                  {uploadResults.results.success
                    ...
                    .map((success, index) => (
                      <div
                        key={index}
                        className="text-sm text-gray-700 bg-white p-3 rounded-lg border border-green-100"
                      >
                        <strong>Row {success.row}:</strong> {success.name}{" "}
                        <span className="text-gray-500">
                          ({success.email})
                  ...
                  {uploadResults.results.success.length > 10 && (
                    <div className="text-gray-500 text-sm text-center bg-white p-2 rounded-lg">
                      ... and {uploadResults.results.success.length - 10}{" "}
                      more
                    </div>
                  )}
